...
/** user_id: числовая часть username; суффикс `_white` снимается (как в боте: `123456789_white`). */
function parseSubPageUserId(username: string): number | null {
    const base = username.endsWith('_white') ? username.slice(0, -'_white'.length) : username
