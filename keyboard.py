...
def keyboard_tariff_bonus():
    return create_kb(
        ...
        **_tariff_keyboard_kwargs(with_trial=True),
    )
...
def keyboard_tariff():
    return create_kb(
        ...
        **_tariff_keyboard_kwargs(with_trial=False),
    )
...
def keyboard_gift_tariff():
    return create_kb(
        ...
        gift_r_90="✅ 90 дней - 749 руб (выгода -16%)",
...
def keyboard_inline_ref(user_id):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="🌐 Подключить Ускоритель соцсетей",
...
def keyboard_discount_push_tariffs() -> InlineKeyboardMarkup:
    ...
    return create_kb(
        ...
        dpush_tariff_90=f'✅ 90 дней — {p["90"]} руб (выгода −44%)',
        dpush_tariff_180=f'🏆 180 дней — {p["180"]} руб (выгода −50%)',
        dpush_tariff_365=f'💎 365 дней — {p["365"]} руб (выгода −55%)',
    )
